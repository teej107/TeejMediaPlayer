...
public class ImagePane extends JPanel
{
	...
	public ImagePane(Image master)
	{
		this(master, true);
	}

	public ImagePane(Image master, boolean toFit)
	{
		setImage(master, toFit);
	}
	...
	public void setImage(Image image, boolean toFit)
	{
		this.master = image;
		setToFit(toFit);
	}
	...
	public Dimension getPreferredSize()
	{
		return master == null ?
				...
				new Dimension(master.getWidth(this), master.getHeight(this));
	}
